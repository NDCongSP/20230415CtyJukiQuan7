...
namespace ATSCADAWebApp
{
    public class xuatexel
    {
        public void Export_alarm(DataTable dt, string thoigian, string title)
        {
            ...
            oBook.SaveAs(rootDir + "BAO CAO\\PMDataReport.xls", excel.XlFileFormat.xlWorkbookNormal,
                   null, null, false, false,
                   excel.XlSaveAsAccessMode.xlExclusive,
                   false, false, false, false, false);
        ...
        public void Export(System.Data.DataTable dt, string thoigian, string title)
        {
            ...
            oBook = (Microsoft.Office.Interop.Excel.Workbook)(oExcel.Workbooks.Add(Type.Missing));
            //oBook = oExcel.Workbooks.Open(@"C:\BAO CAO ATPRO\" + FileName + ".xlsx");
            ...
            Microsoft.Office.Interop.Excel.Range cl1 = oSheet.get_Range("A2", "E2");
            ...
            //thay doi ten cot Temp va Humi tuong ung voi tung bang
            Microsoft.Office.Interop.Excel.Range cl3 = oSheet.get_Range("A3", "A3");
            cl3.Value2 = "DateTime";
            cl3.ColumnWidth = 30.0;
            Microsoft.Office.Interop.Excel.Range cl4 = oSheet.get_Range("B3", "B3");
            cl4.Value2 = "Temp_Sensor1";
            cl4.ColumnWidth = 20.0;
            Microsoft.Office.Interop.Excel.Range cl5 = oSheet.get_Range("C3", "C3");
            cl5.Value2 = "Humi_Sensor1";
            cl5.ColumnWidth = 20.0;

            Microsoft.Office.Interop.Excel.Range cl6 = oSheet.get_Range("D3", "D3");
            cl6.Value2 = "Temp_Sensor2";
            cl6.ColumnWidth = 20.0;
            Microsoft.Office.Interop.Excel.Range cl7 = oSheet.get_Range("E3", "E3");
            cl7.Value2 = "Humi_Sensor2";
            cl7.ColumnWidth = 20.0;
            // Tạo mẳng đối tượng để lưu dữ toàn bồ dữ liệu trong DataTable,
            ...
            oSheet.get_Range(c3, c4).HorizontalAlignment = Microsoft.Office.Interop.Excel.XlHAlign.xlHAlignCenter;
            //luu
            //oBook.SaveAs(@"C:\BAO CAO ATPRO\REPORT.xls", excel.XlFileFormat.xlWorkbookNormal,
            //    null, null, false, false,
            //    excel.XlSaveAsAccessMode.xlExclusive,
            //    false, false, false, false, false);
            oBook.Close(false, false, false);
